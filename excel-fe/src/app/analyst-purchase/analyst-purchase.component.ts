...
@Component({
  selector: 'app-analyst-purchase',
  templateUrl: './analyst-purchase.component.html',
  styleUrls: ['./analyst-purchase.component.scss'],
  standalone: false
})
export class AnalystPurchaseComponent {
  ...
  @ViewChild('purchaseUploadSort') purchaseUploadSort!: MatSort;
  ...
  constructor(private fileUploadService: UploadService,
    ...
    private fileDownloadService: DownloadService) {
     ...
     this.fetchUploads(this.userId, this.type);
  }

  ngAfterViewInit(): void {
    //console.log('Sort ngAfter View Init:', this.purchaseUploadSort);
    this.dataSource.paginator = this.paginator;
    this.dataSource.sort = this.purchaseUploadSort;
      ...
      reader.onload = (e: any) => {
        ...
        if (this.validateSchema(headers)) {
          ...
          if (validationResult.isValid) {
            ...
            formData.append('sheet', 'purchases'); // Specify the sheet name
            ...
            this.fileUploadService.uploadFile(formData).subscribe(
              (response: any) => {
                ...
                this.fetchUploads(this.userId, this.type); // Fetch uploads data after successful upload
