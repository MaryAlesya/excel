...
public class Purchases { 
	...
	@Override
	public int hashCode() {
		return Objects.hash(average, id, item, purchaseDate, score, total, value1, value2, value3);
	}
	@Override
	public boolean equals(Object obj) {
		...
		return Double.doubleToLongBits(average) == Double.doubleToLongBits(other.average)
				...
				&& Objects.equals(purchaseDate, other.purchaseDate) && Objects.equals(score, other.score)
	...
	public String toString() {
		return "Purchases [id=" + id + ", item=" + item + ", purchaseDate=" + purchaseDate + ", value1=" + value1
				+ ", value2=" + value2 + ", value3=" + value3 + ", total=" + total + ", average=" + average + ", score="
				+ score + "]";
	}
